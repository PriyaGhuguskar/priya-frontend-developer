        ...
        <header className="p-4 bg-gray-800 text-gray-100">
            ...
            <div className="container flex justify-between h-16 mx-auto">
                <Link to='/' className="flex items-center p-2">
                    <svg xmlns="http://www.w3.org/2000/svg" height="100" width="300" fill="currentcolor" viewBox="-59.625 -12.15 516.75 72.9">
                ...
                <Link to='/' className="flex items-center p-2"></Link>

                <ul className="items-stretch hidden space-x-3 md:flex">
                    <li className="flex">
                        <Link to='/' className="flex items-center px-4 -mb-1 border-b-2 border-transparent text-violet-400 border-violet-400">Home</Link>
                    </li>
                    <li className="flex">
                        <Link to='/' className="flex items-center px-4 -mb-1 border-b-2 border-transparent">Capsule</Link>
                    </li>
                    <li className="flex">
                        <Link to='/' className="flex items-center px-4 -mb-1 border-b-2 border-transparent">About</Link>
                    </li>
                    <li className="flex">
                        <Link to='/' className="flex items-center px-4 -mb-1 border-b-2 border-transparent">Contact</Link>
                    </li>
                </ul>
                <button aria-label="nav" onClick={() => alert("Comming soon...")} className="flex justify-end p-4 md:hidden">
