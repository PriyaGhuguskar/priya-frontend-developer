        ...
        <footer className="px-4 divide-y bg-gray-800 text-gray-100">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        <h3 className="uppercase text-gray-50">Navigate</h3>
                        <ul className="space-y-1">
                            <li>
            ...
            <div className="py-6 text-sm text-center text-gray-400">© 1968 TesalCapsule Co. All rights reserved.</div>
        </footer>
    )
}

export default FootCompo